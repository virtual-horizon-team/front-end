            ...
            <div className="w-full max-w-[1600px] flex flex-col lg:flex-row min-h-screen items-stretch relative bg-white">
                ...
                <div className="hidden lg:flex lg:w-[45%] xl:w-[40%] relative bg-[#4f66fb] flex-col m-4 lg:m-6 xl:m-8 rounded-[40px] shadow-2xl z-10 shrink-0">
                    ...
                    <div className="relative flex-1 w-full mt-8 pointer-events-none">
                        {/* Stars: Anchored from the LEFT to match the VR Man's left-anchor, preventing star drift under zoom changes */}
                        <div className="absolute left-[45%] top-[5%] w-16 h-16 lg:w-20 lg:h-20 xl:w-28 xl:h-28 animate-pulse z-20">
                            <Image 
                        ...
                        <div className="absolute left-[20%] top-[15%] w-8 h-8 lg:w-10 lg:h-10 xl:w-14 xl:h-14 animate-pulse delay-150 z-20">
                            <Image 
                                src="/images/Burst-pucker-2.png" 
                                alt="Star Burst" 
                                fill 
                        ...
                        <div className="absolute left-[30%] top-[25%] w-6 h-6 lg:w-8 lg:h-8 xl:w-10 xl:h-10 animate-pulse delay-300 z-20">
                            <Image 
                                src="/images/Burst-pucker-2.png" 
                                alt="Star Burst" 
                                fill 
                        ...
                        {/* Man Image - Original positioning and scale */}
                ...
                {/* Right Side (Forms) - Original classes, layout settings, and paddings */}
